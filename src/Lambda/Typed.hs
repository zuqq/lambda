...
sub :: Sub -> Term -> Term
sub s (Var n t)    = Var n (Type.apply s t)
sub s (Abs b t)    = Abs (sub s b) (Type.apply s t)
sub s (App a a' t) = App (sub s a) (sub s a') (Type.apply s t)
